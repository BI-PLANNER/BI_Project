  ...
  return (
    <div className="relative min-h-screen text-slate-900 p-4 md:p-6 max-w-[1750px] mx-auto space-y-6 font-sans">
      ...
      <div className="relative z-10 space-y-6">
        ...
        <div className="relative overflow-hidden rounded-[2.5rem] bg-white border border-slate-300 border border-slate-300/[0.08] p-6 md:p-8 shadow-[0_20px_50px_rgba(0,0,0,0.5),inset_0_1px_0_0_rgba(255,255,255,0.1)] backdrop-blur-2xl">
          {/* Subtle Accent Glow Line */}
          <div className="absolute top-0 left-0 right-0 h-[2px] bg-white border border-slate-300" />

          <div className="flex flex-col xl:flex-row xl:items-center justify-between gap-6">
            <div className="space-y-2">
              <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-cyan-500/10 border border-slate-300 text-cyan-700 text-xs font-mono font-semibold tracking-wider">
              ...
              <h1 className="text-3xl md:text-4xl font-extrabold tracking-tight bg-white border border-slate-300 bg-clip-text text-transparent flex flex-wrap items-center gap-3">
                Gestión Inteligente de Inventario & ROP
                <span className="text-xs font-mono px-3 py-1 rounded-xl bg-white text-cyan-700 border border-slate-300 font-bold shadow-inner">
            ...
            <div className="flex flex-wrap items-center gap-3">
              <button
                ...
                className={`relative group flex items-center gap-2.5 px-4 py-2.5 rounded-2xl border text-xs font-bold transition duration-300 shadow-sm overflow-hidden ${
                  syncing
                    ? 'bg-amber-500/20 text-amber-700 border-slate-300 cursor-wait'
                    : 'bg-white hover:bg-slate-100 text-slate-800 border-slate-300/[0.08] hover:border-slate-300 hover:shadow-cyan-500/10'
                }`}
              >
              ...
              <button
                ...
                className="flex items-center gap-2 px-4 py-2.5 rounded-2xl bg-white hover:bg-slate-100 text-slate-800 border border-slate-300/[0.08] hover:border-slate-300 text-xs font-bold transition shadow-sm hover:shadow-purple-500/10"
              >
        ...
        <div className="relative p-1.5 rounded-2xl bg-white border border-slate-300/[0.08] backdrop-blur-2xl shadow-sm flex flex-wrap items-center justify-between gap-2">
              ...
              return (
                <button
                  ...
                  className={`relative flex items-center gap-2 px-3.5 py-2.5 rounded-xl text-xs font-bold transition-all duration-300 group ${
                    isLocked
                      ? 'bg-white text-slate-500 border border-slate-300/[0.04] hover:border-slate-300 hover:bg-amber-500/[0.04] cursor-not-allowed opacity-75 hover:opacity-100'
                      : isActive
                      ? 'bg-white border border-slate-300 text-gray-900 shadow-[0_0_20px_rgba(99,102,241,0.4)] border border-slate-300 cursor-pointer'
                ...
                >
                  ...
                  {isLocked ? (
                    <span className="flex items-center gap-1 text-[9.5px] font-mono px-2 py-0.5 rounded-full bg-amber-500/10 text-amber-700 border border-slate-300 group-hover:border-slate-300 transition">
                      <Lock className="w-2.5 h-2.5" />
                      <span>{tab.versionTag}</span>
                    </span>
                  ) : (
                    <span className={`text-[10px] font-mono px-2 py-0.5 rounded-full ${
                      isActive ? 'bg-slate-50 text-cyan-800' : 'bg-white text-slate-700 border border-slate-300/[0.06]'
                    }`}>
                      {tab.badge}
                    </span>
                  )}
          ...
          {activeTab === 'catalogo' && (
            <div className="flex items-center bg-white border border-slate-300/[0.08] rounded-xl p-1 ml-auto">
              <button
        ...
        {notification && (
          <div className={`p-4 rounded-2xl flex items-center justify-between text-xs font-semibold border backdrop-blur-xl animate-fade-in shadow-sm ${
            notification.type === 'success'
              ? 'bg-emerald-500/10 text-emerald-700 border-slate-300 shadow-emerald-500/5'
              : notification.type === 'error'
              ? 'bg-rose-500/10 text-rose-700 border-slate-300 shadow-rose-500/5'
              : 'bg-indigo-500/10 text-indigo-700 border-slate-300 shadow-indigo-500/5'
          }`}>
        ...
        {activeTab === 'catalogo' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="relative overflow-hidden rounded-3xl bg-white border border-slate-300/[0.08] p-5 shadow-sm backdrop-blur-xl group hover:border-slate-300 transition duration-300">
                <div className="absolute top-0 left-0 right-0 h-[2px] bg-white border border-slate-300 opacity-50 group-hover:opacity-100 transition" />
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-slate-700 uppercase tracking-wider">Catálogo Total</span>
                  <div className="p-2.5 rounded-2xl bg-cyan-500/10 border border-slate-300 text-cyan-700"><Boxes className="w-4 h-4" /></div>
                </div>
                <div className="mt-3">
                  ...
                  <div className="text-[9.5px] font-mono text-cyan-700/80 mt-2 pt-1.5 border-t border-slate-300/[0.06] flex items-center gap-1">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-white border border-slate-300/[0.08] p-5 shadow-sm backdrop-blur-xl group hover:border-slate-300 transition duration-300">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="p-2.5 rounded-2xl bg-purple-500/10 border border-slate-300 text-purple-700"><Cpu className="w-4 h-4" /></div>
                </div>
                <div className="mt-3">
                  ...
                  <div className="text-[9.5px] font-mono text-purple-700/80 mt-2 pt-1.5 border-t border-slate-300/[0.06] flex items-center gap-1">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-white border border-slate-300/[0.08] p-5 shadow-sm backdrop-blur-xl group hover:border-slate-300 transition duration-300">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="p-2.5 rounded-2xl bg-indigo-500/10 border border-slate-300 text-indigo-700"><Tag className="w-4 h-4" /></div>
                </div>
                <div className="mt-3">
                  ...
                  <div className="text-[9.5px] font-mono text-indigo-700/80 mt-2 pt-1.5 border-t border-slate-300/[0.06] flex items-center gap-1">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-white border border-slate-300/[0.08] p-5 shadow-sm backdrop-blur-xl group hover:border-slate-300 transition duration-300">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="p-2.5 rounded-2xl bg-emerald-500/10 border border-slate-300 text-emerald-700"><Globe className="w-4 h-4" /></div>
                </div>
                <div className="mt-3">
                  ...
                  <div className="text-[9.5px] font-mono text-emerald-700/80 mt-2 pt-1.5 border-t border-slate-300/[0.06] flex items-center gap-1">
            ...
            <div className="space-y-4">
              {/* Chart Mode Controls */}
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 rounded-2xl bg-white border border-slate-300/[0.06] backdrop-blur-xl">
                <div className="flex items-center gap-2">
                  <span className="p-1.5 rounded-lg bg-cyan-500/10 text-cyan-700 border border-slate-300">
                ...
                <div className="flex items-center bg-white p-1 rounded-xl border border-slate-300/[0.06] text-xs font-bold">
                  <button
              ...
              {(chartModeCatalogo === 'hybrid' || chartModeCatalogo === 'bars') && (
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
                  <div className="lg:col-span-8 rounded-3xl bg-white border border-slate-300/[0.08] p-6 shadow-sm backdrop-blur-xl space-y-4">
                    <div className="flex items-center justify-between border-b border-slate-300/[0.06] pb-3">
                      <div className="flex items-center gap-2">
                          ...
                          <div key={item.marca} className="space-y-1 group">
                            <div className="flex items-center justify-between text-xs">
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                <span className="font-mono font-bold text-gray-900 px-2 py-0.5 rounded-md bg-white border border-slate-300/[0.06] text-xs">
                                  {item.count} SKUs
                                </span>
                              </div>
                            </div>

                            <div className="w-full h-3 bg-white rounded-full overflow-hidden border border-slate-300/[0.06] flex">
                              <div
                  ...
                  <div className="lg:col-span-4 rounded-3xl bg-white border border-slate-300/[0.08] p-6 shadow-sm backdrop-blur-xl flex flex-col justify-between space-y-4">
                    <div className="border-b border-slate-300/[0.06] pb-3">
                      <div className="flex items-center gap-2">
                    ...
                    <div className="pt-3 border-t border-slate-300/[0.06] text-[11px] text-slate-700 flex items-center justify-between">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              <div className="lg:col-span-3 space-y-4">
                <div className="rounded-3xl bg-white border border-slate-300/[0.08] p-5 shadow-sm backdrop-blur-xl space-y-5">
                  <div className="flex items-center justify-between border-b border-slate-300/[0.06] pb-3">
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-[9px] font-mono text-cyan-700/80 bg-cyan-50 px-1.5 py-0.5 rounded border border-slate-300">Filtro LIKE</span>
                    </div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full pl-9 pr-8 py-2 bg-white border border-slate-300/[0.08] rounded-xl text-xs text-gray-900 placeholder-slate-500 focus:outline-none focus:border-cyan-500 transition"
                      />
                      {search && (
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-[9px] font-mono text-purple-700/80 bg-purple-50 px-1.5 py-0.5 rounded border border-slate-300">es_equipo (BOOL)</span>
                    </div>
                    <p className="text-[9.5px] font-mono text-slate-700 mb-2">Reactivos (FALSE) vs Equipos / Analizadores (TRUE)</p>
                    <div className="grid grid-cols-3 gap-1.5 bg-white p-1 rounded-2xl border border-slate-300/[0.06]">
                      <button
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-[9px] font-mono text-emerald-700/80 bg-emerald-50 px-1.5 py-0.5 rounded border border-slate-300">activo (1 / 0)</span>
                    </div>
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <div className="flex items-center gap-1.5">
                        <span className="text-[9px] font-mono text-cyan-700/80 bg-cyan-50 px-1.5 py-0.5 rounded border border-slate-300">marcas.marca_id</span>
                      ...
                      {marcas.map(m => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <span className="text-[10px] font-mono px-1.5 py-0.5 rounded bg-white text-slate-700 border border-slate-300/[0.04]">
                              {prodCount}
                            </span>
                          </button>
                        )
              ...
              <div className="lg:col-span-9 space-y-4">
                {activeFiltersCount > 0 && (
                  <div className="rounded-2xl bg-white border border-slate-300/[0.06] p-3 flex flex-wrap items-center gap-2 text-xs backdrop-blur-xl">
                    ...
                    {search && (
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl bg-cyan-500/10 text-cyan-700 border border-slate-300 text-xs font-mono">
                        Búsqueda: &quot;{search}&quot;
                    ...
                    {selectedTipo !== 'todos' && (
                      <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl bg-purple-500/10 text-purple-700 border border-slate-300 text-xs font-mono">
                    ...
                    {selectedMarcas.map(mId => {
                      ...
                      return (
                        <span key={mId} className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl bg-indigo-500/10 text-indigo-700 border border-slate-300 text-xs font-mono">
                ...
                {catalogViewMode === 'table' ? (
                  <div className="rounded-3xl bg-white border border-slate-300/[0.08] shadow-sm overflow-hidden backdrop-blur-xl">
                    <div className="overflow-x-auto">
                      <table className="w-full text-left text-xs">
                        <thead className="bg-white text-slate-700 uppercase font-bold text-[10px] border-b border-slate-300/[0.06] sticky top-0 z-10 backdrop-blur-md">
                          <tr>
                            ...
                            paginatedProductos.map((p, idx) => (
                              <tr key={p.producto_equipo_id} className="hover:bg-white/[0.04] hover:shadow-[0_0_20px_rgba(99,102,241,0.1)] transition-all duration-200">
                                <td className="px-4 py-3.5">
                                  <span className="font-mono font-bold text-cyan-700 bg-cyan-500/10 px-2.5 py-1 rounded-lg border border-slate-300 text-xs">
                                    {p.codigo_sku}
                                  </span>
                                </td>
                                <td className="px-4 py-3.5">
                                ...
                                <td className="px-4 py-3.5">
                                  <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-lg bg-white text-slate-700 border border-slate-300/[0.06] text-xs font-semibold">
                                ...
                                <td className="px-4 py-3.5 text-center">
                                  <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-[10px] font-extrabold font-mono border ${
                                    p.es_equipo ? 'bg-purple-500/10 text-purple-700 border-slate-300' : 'bg-cyan-500/10 text-cyan-700 border-slate-300'
                                  }`}>
                                    {p.es_equipo ? 'EQUIPO' : 'REACTIVO'}
                                  </span>
                                </td>
                                ...
                                <td className="px-4 py-3.5 text-right">
                                  <div className="flex items-center justify-end gap-1.5">
                                    <button onClick={() => handleOpenEdit(p)} className="p-1.5 rounded-xl bg-white hover:bg-cyan-600 hover:text-gray-900 text-slate-700 transition border border-slate-300/[0.06]">
                                      <Edit2 className="w-3.5 h-3.5" />
                                    </button>
                                    <button onClick={() => handleDelete(p.producto_equipo_id)} className="p-1.5 rounded-xl bg-white hover:bg-gray-100 hover:text-rose-700 text-slate-700 transition border border-slate-300/[0.06]">
                    ...
                    <div className="p-4 border-t border-slate-300/[0.06] bg-white flex flex-col sm:flex-row items-center justify-between gap-4 text-xs">
                      <div className="text-slate-700 flex items-center gap-2">
                        ...
                        <select
                          ...
                          className="px-2.5 py-1 bg-white border border-slate-300/[0.08] rounded-xl text-xs text-gray-900"
                        >
                      ...
                      <div className="flex items-center gap-2">
                        <button
                          ...
                          className="p-2 rounded-xl bg-white hover:bg-slate-100 text-slate-700 disabled:opacity-30 disabled:cursor-not-allowed border border-slate-300/[0.06]"
                        >
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                    {paginatedProductos.map(p => (
                      <div key={p.producto_equipo_id} className="relative overflow-hidden rounded-3xl bg-white border border-slate-300/[0.08] p-5 shadow-sm hover:border-slate-300 transition-all duration-300 flex flex-col justify-between space-y-4 backdrop-blur-xl group">
                        <div className="space-y-3">
                          <div className="flex items-start justify-between gap-2">
                            <span className="text-xs font-mono font-bold text-cyan-700 bg-cyan-500/10 px-2.5 py-1 rounded-lg border border-slate-300">
                              {p.codigo_sku}
                            </span>
                          ...
                          <div className="text-xs text-slate-700 space-y-1.5 pt-1">
                            ...
                            {p.descripcion && <p className="text-slate-500 text-xs line-clamp-2 pt-1 border-t border-slate-300/[0.04]">{p.descripcion}</p>}
                          </div>
                        </div>

                        <div className="pt-3 border-t border-slate-300/[0.06] flex items-center justify-between text-xs">
        ...
        {activeTab === 'inventario' && (
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 rounded-2xl bg-white border border-slate-300/[0.06] backdrop-blur-xl">
              <div className="flex items-center gap-2">
                <span className="p-1.5 rounded-lg bg-amber-500/10 text-amber-700 border border-slate-300">
            ...
            {(chartModeInventario === 'hybrid' || chartModeInventario === 'bars') && (
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                <div className="rounded-3xl bg-white border border-slate-300/[0.08] p-6 shadow-sm space-y-4 backdrop-blur-xl">
                  <div className="flex items-center justify-between border-b border-slate-300/[0.06] pb-4">
                    <div>
                    ...
                    <span className="text-xs font-mono font-bold px-3 py-1 rounded-xl bg-amber-500/10 text-amber-700 border border-slate-300">
                      40,950+ Kits Totales
                    </span>
                  </div>
                  ...
                  <div className="space-y-3 max-h-[420px] overflow-y-auto pr-2 custom-scrollbar">
                    {[
                      ...
                      <div key={item.marca} className="space-y-1.5 p-2.5 rounded-2xl bg-white border border-slate-300/[0.04]">
                        <div className="flex items-center justify-between text-xs">
                        ...
                        <div className="w-full h-2.5 bg-white rounded-full overflow-hidden border border-slate-300/[0.06] flex">
                ...
                <div className="rounded-3xl bg-white border border-slate-300/[0.08] p-6 shadow-sm space-y-5 backdrop-blur-xl flex flex-col justify-between">
                  <div>
                    <div className="flex items-center justify-between border-b border-slate-300/[0.06] pb-4">
                      <div>
                        <h3 className="text-base font-bold text-gray-900 flex items-center gap-2">
                      ...
                      <button
                        ...
                        className={`p-4 rounded-2xl border text-center transition-all duration-300 relative group cursor-pointer ${
                          selectedLotStatusFilter === 'vencidos'
                            ...
                            : 'bg-rose-500/10 border-slate-300 hover:border-slate-300 hover:bg-gray-100'
                        }`}
                      >
                        ...
                        <div className="text-[9px] font-mono text-rose-700/80 bg-rose-50 px-1.5 py-0.5 rounded mt-2 border border-slate-300">
                          (Vence - Hoy) &lt; 0d
                        </div>
                      ...
                      <button
                        ...
                        className={`p-4 rounded-2xl border text-center transition-all duration-300 relative group cursor-pointer ${
                          selectedLotStatusFilter === 'menos30'
                            ...
                            : 'bg-amber-500/10 border-slate-300 hover:border-slate-300 hover:bg-gray-100'
                        }`}
                      >
                        ...
                        <div className="text-[9px] font-mono text-amber-700/80 bg-amber-50 px-1.5 py-0.5 rounded mt-2 border border-slate-300">
                          0d ≤ (Vence - Hoy) ≤ 30d
                        </div>
                      ...
                      <button
                        ...
                        className={`p-4 rounded-2xl border text-center transition-all duration-300 relative group cursor-pointer ${
                          selectedLotStatusFilter === 'menos90'
                            ...
                            : 'bg-indigo-500/10 border-slate-300 hover:border-slate-300 hover:bg-gray-100'
                        }`}
                      >
                        ...
                        <div className="text-[9px] font-mono text-indigo-700/80 bg-indigo-50 px-1.5 py-0.5 rounded mt-2 border border-slate-300">
                          31d ≤ (Vence - Hoy) ≤ 90d
                        </div>
                    ...
                    <div className="mt-6 p-4 rounded-2xl bg-white border border-slate-300/[0.06] space-y-2">
                  ...
                  <div className="pt-4 border-t border-slate-300/[0.06] flex items-center justify-between text-xs text-slate-700">
        ...
        {activeTab === 'envios_mensajeria' && (
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-white border border-slate-300/[0.08] p-4 rounded-3xl backdrop-blur-xl shadow-sm">
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center bg-white p-1 rounded-xl border border-slate-300/[0.06]">
                  <button
                ...
                <button
                  onClick={handleSyncData}
                  disabled={syncing}
                  className="flex items-center gap-2 px-3.5 py-1.5 rounded-xl bg-cyan-600/20 hover:bg-gray-100 text-cyan-700 border border-slate-300 text-xs font-bold transition shadow-sm cursor-pointer disabled:opacity-50"
                >
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-5 gap-3 sm:gap-4">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-white border border-slate-300/[0.08] p-5 shadow-sm backdrop-blur-xl group hover:border-slate-300 transition duration-300">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="p-2.5 rounded-2xl bg-cyan-500/10 border border-slate-300 text-cyan-700"><Package className="w-4 h-4" /></div>
                </div>
                <div className="mt-3">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-white border border-slate-300/[0.08] p-5 shadow-sm backdrop-blur-xl group hover:border-slate-300 transition duration-300">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="p-2.5 rounded-2xl bg-emerald-500/10 border border-slate-300 text-emerald-700"><TrendingUp className="w-4 h-4" /></div>
                </div>
                <div className="mt-3">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-white border border-slate-300/[0.08] p-5 shadow-sm backdrop-blur-xl group hover:border-slate-300 transition duration-300">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="p-2.5 rounded-2xl bg-rose-500/10 border border-slate-300 text-rose-700"><Zap className="w-4 h-4" /></div>
                </div>
                <div className="mt-3">
                  ...
                  <div className="text-[9.5px] font-mono text-rose-700/80 mt-2 pt-1.5 border-t border-slate-300/[0.06] flex items-center gap-1">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-white border border-slate-300/[0.08] p-5 shadow-sm backdrop-blur-xl group hover:border-slate-300 transition duration-300">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="p-2.5 rounded-2xl bg-purple-500/10 border border-slate-300 text-purple-700"><Compass className="w-4 h-4" /></div>
                </div>
                <div className="mt-3">
              ...
              <div className="relative overflow-hidden rounded-3xl bg-white border border-slate-300/[0.08] p-5 shadow-sm backdrop-blur-xl group hover:border-slate-300 transition duration-300 col-span-2 lg:col-span-1">
                <div className="absolute top-0 left-0 right-0 h-[2px] bg-white border border-slate-300 opacity-50 group-hover:opacity-100 transition" />
                <div className="flex items-center justify-between">
                  <span className="text-xs font-bold text-slate-700 uppercase tracking-wider">POD Sello Digital</span>
                  <div className="p-2.5 rounded-2xl bg-blue-500/10 border border-slate-300 text-blue-700"><FileCheck className="w-4 h-4" /></div>
                </div>
                <div className="mt-3">
                  ...
                  <div className="text-[9.5px] font-mono text-blue-700/80 mt-2 pt-1.5 border-t border-slate-300/[0.06] flex items-center gap-1">
            ...
            {logisticsSubTab === 'analytics' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="lg:col-span-2 bg-white border border-slate-300/[0.08] rounded-3xl p-6 shadow-sm backdrop-blur-xl space-y-4">
                    <div className="flex items-center justify-between border-b border-slate-300/[0.06] pb-3">
                  ...
                  <div className="bg-white border border-slate-300/[0.08] rounded-3xl p-6 shadow-sm backdrop-blur-xl space-y-4 flex flex-col justify-between">
                    <div>
                      <div className="flex items-center gap-2.5 border-b border-slate-300/[0.06] pb-3">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                  ...
                  <div className="bg-white border border-slate-300/[0.08] rounded-3xl p-6 shadow-sm backdrop-blur-xl space-y-4">
                    <div className="flex items-center gap-2.5 border-b border-slate-300/[0.06] pb-3">
            ...
            {/* ===================================================================== */}
            {logisticsSubTab === 'live_table' && (
              <div className="rounded-3xl bg-white border border-slate-300/[0.08] p-6 shadow-sm space-y-5 backdrop-blur-xl">
                <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-4 border-b border-slate-300/[0.06] pb-4">
                  <div className="space-y-1">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-mono font-bold px-2.5 py-0.5 rounded-full bg-cyan-500/20 text-cyan-700 border border-slate-300">
                  ...
                  <div className="flex flex-wrap items-center gap-3">
                    ...
                    <select
                      ...
                      className="px-3 py-1.5 bg-white border border-slate-300/[0.08] rounded-xl text-xs text-gray-900 focus:outline-none focus:border-cyan-500"
                    >
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="pl-8 pr-3 py-1.5 bg-white border border-slate-300/[0.08] rounded-xl text-xs text-gray-900 placeholder-slate-500 focus:outline-none focus:border-cyan-500 w-56"
                      />
                    </div>
                  </div>
                </div>
                ...
                {/* Tabla de Envíos */}
                <div className="overflow-x-auto rounded-2xl border border-slate-300/[0.06]">
                  <table className="w-full text-left text-xs">
                    <thead className="bg-white text-slate-700 uppercase font-bold text-[10px] border-b border-slate-300/[0.06]">
                      <tr>
                          ...
                          <tr key={item.id} className="hover:bg-white/[0.04] transition">
                            ...
                            <td className="px-3 py-3">
                              ...
                              <span className={`inline-block text-[9.5px] font-bold px-2 py-0.5 rounded-full border mt-0.5 ${
                                item.region === 'CENTRAL'
                                  ? 'bg-cyan-500/10 text-cyan-700 border-slate-300'
                                  : item.region === 'OCCIDENTAL'
                                  ? 'bg-emerald-500/10 text-emerald-700 border-slate-300'
                                  : 'bg-amber-500/10 text-amber-700 border-slate-300'
                              }`}>
                                {item.region}
                              </span>
                            </td>
                            ...
                            <td className="px-3 py-3 text-center">
                              {item.es_urgente ? (
                                <span className="inline-flex items-center gap-1 text-[10px] font-mono font-bold px-2 py-0.5 rounded-full bg-rose-500/20 text-rose-700 border border-slate-300">
                            ...
                            <td className="px-3 py-3 whitespace-nowrap">
                              <span className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-xl text-xs font-semibold border ${
                                item.estado.includes('Entregado')
                                  ? 'bg-emerald-50 text-emerald-700 border-slate-300'
                                  : item.estado.includes('Tránsito')
                                  ? 'bg-cyan-50 text-cyan-700 border-slate-300'
                                  : 'bg-rose-50 text-rose-700 border-slate-300'
                              }`}>
                            ...
                            <td className="px-4 py-3 text-center">
                              {item.pdf ? (
                                <button
                                  ...
                                  className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-lg bg-blue-500/10 hover:bg-gray-100 text-blue-700 border border-slate-300 text-[11px] font-mono font-bold transition cursor-pointer"
                                >
        ...
        {activeTab === 'rop' && (
          <div className="space-y-6">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <button
                ...
                className={`rounded-3xl border p-5 shadow-sm backdrop-blur-xl flex flex-col justify-between text-left transition-all duration-300 cursor-pointer ${
                  ropStatusFilter === 'URGENTE'
                    ...
                    : 'bg-white border-slate-300 hover:border-slate-300 hover:bg-gray-100'
                }`}
              >
                <div className="flex items-center justify-between">
              ...
              >
                ...
                <div className="mt-2">
                  ...
                  <div className="text-[9.5px] font-mono text-amber-700/80 mt-2 pt-1.5 border-t border-slate-300/[0.06] flex items-center gap-1">
              ...
              <div className="rounded-3xl bg-white border border-slate-300 p-5 shadow-sm backdrop-blur-xl flex flex-col justify-between">
                <div className="flex items-center justify-between">
            ...
            <div className="rounded-3xl bg-white border border-slate-300/[0.08] p-6 shadow-sm backdrop-blur-xl space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-300/[0.06] pb-3">
                <div>
                ...
                <div className="relative w-full sm:w-64">
                  ...
                  <input
                    ...
                    className="w-full pl-9 pr-3 py-1.5 bg-white border border-slate-300/[0.08] rounded-xl text-xs text-gray-900 placeholder-slate-500 focus:outline-none focus:border-cyan-500"
                  />
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 pt-1">
                <div className="p-3 rounded-2xl bg-white border border-slate-300/[0.04] space-y-1.5">
                ...
                <div className="p-3 rounded-2xl bg-white border border-slate-300/[0.04] space-y-1.5">
                  ...
                  <select
                    ...
                    className="w-full px-2.5 py-1 bg-white border border-slate-300/[0.08] rounded-xl text-xs text-gray-900"
                  >
                ...
                <div className="rounded-3xl bg-white border border-slate-300/[0.08] p-6 shadow-sm backdrop-blur-xl space-y-4">
                  ...
                  <div className="space-y-4 pt-1">
                    {ropData.slice(0, 6).map(item => {
                      ...
                      return (
                        <div key={item.sku} className="space-y-1.5 p-3 rounded-2xl bg-white border border-slate-300/[0.04]">
                          <div className="flex items-center justify-between text-xs">
                            <div className="flex items-center gap-2">
                              <span className="font-mono font-bold text-cyan-700 bg-cyan-500/10 px-2 py-0.5 rounded border border-slate-300 text-[11px]">{item.sku}</span>
                            ...
                            <div className="flex items-center gap-3 font-mono text-xs">
                              ...
                              {item.suggestedOrder > 0 && (
                                <span className="text-emerald-700 font-bold bg-emerald-500/10 px-2 py-0.5 rounded border border-slate-300 text-[11px]">
                            ...
                            <div className="w-full h-2 bg-white rounded-full overflow-hidden flex">
                              <div
                                className={`h-full rounded-full transition-all duration-500 ${
                                  item.status === 'URGENTE'
                                    ? 'bg-white border border-slate-300 shadow-[0_0_10px_rgba(244,63,94,0.4)]'
                                    : item.status === 'REORDEN'
                                    ? 'bg-white border border-slate-300 shadow-[0_0_10px_rgba(245,158,11,0.4)]'
                                    : 'bg-white border border-slate-300 shadow-[0_0_10px_rgba(6,182,212,0.4)]'
                                }`}
            ...
            <div className="rounded-3xl bg-white border border-slate-300/[0.08] shadow-sm overflow-hidden backdrop-blur-xl space-y-4 p-5">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-slate-300/[0.06] pb-3">
                <div className="flex items-center gap-2">
                  <div className="flex items-center bg-white p-1 rounded-xl border border-slate-300/[0.06] text-xs font-bold">
                    <button
                ...
                <div className="flex items-center gap-2">
                  <button
                    ...
                    className="flex items-center gap-1.5 px-3.5 py-1.5 rounded-xl bg-white border border-slate-300 hover:bg-gray-100 text-gray-900 text-xs font-bold transition shadow-sm cursor-pointer"
                  >
                          ...
                          <td className="px-3 py-3 text-center">
                            <span className={`inline-flex items-center px-2.5 py-0.5 rounded-full font-bold font-mono text-[10px] border ${
                              item.status === 'URGENTE'
                                ...
                                ? 'bg-purple-500/20 text-purple-700 border-slate-300'
        ...
        {activeTab === 'rentabilidad' && (
          <div className="space-y-6">
            <div className="grid grid-cols-2 sm:grid-cols-2 lg:grid-cols-4 gap-4">
              <div className="rounded-3xl bg-white border border-slate-300/[0.08] p-5 shadow-sm backdrop-blur-xl flex flex-col justify-between">
                <div className="flex items-center justify-between">
            ...
            <div className="rounded-3xl bg-white border border-slate-300/[0.08] p-6 shadow-sm backdrop-blur-xl space-y-4">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 pt-2">
                <div className="space-y-1.5 bg-white p-4 rounded-2xl border border-slate-300/[0.06]">
            ...
            <div className="space-y-4">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 rounded-2xl bg-white border border-slate-300/[0.06] backdrop-blur-xl">
                <div className="flex items-center gap-2">
                  <span className="p-1.5 rounded-lg bg-emerald-500/10 text-emerald-700 border border-slate-300">
                    <TrendingUp className="w-3.5 h-3.5" />
                  </span>
                  <div>
                    <h3 className="text-xs font-bold text-gray-900 uppercase tracking-wider">
                ...
                <div className="rounded-3xl bg-white border border-slate-300/[0.08] p-6 shadow-sm backdrop-blur-xl space-y-4">
                  ...
                  <div className="space-y-3.5 pt-1">
                    {rentabilidadModels.map((item, idx) => {
                      ...
                      return (
                        <div key={item.linea} className="space-y-1.5 p-3 rounded-2xl bg-white border border-slate-300/[0.04]">
                          <div className="flex items-center justify-between text-xs">
                            <div className="flex items-center gap-2">
                            ...
                            <div className="flex items-center gap-3 font-mono text-xs">
                              ...
                              <span className="font-mono font-bold text-emerald-700 bg-emerald-500/10 px-2.5 py-0.5 rounded border border-slate-300 text-xs">
                                ${Math.round(item.utilidadBrutaTotal).toLocaleString()}
                              </span>
                            </div>
                          </div>

                          <div className="w-full h-3 bg-white rounded-full overflow-hidden border border-slate-300/[0.04] flex">
                            <div
        ...
        {activeTab === 'proveedores' && (
          <div className="space-y-6">
            <div className="rounded-3xl bg-white border border-slate-300/[0.08] p-6 shadow-sm space-y-6 backdrop-blur-xl">
              <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4 border-b border-slate-300/[0.06] pb-4">
                <div>
                ...
                <div className="flex flex-col gap-1 w-full sm:w-72">
                  ...
                  <div className="relative w-full">
                    ...
                    <input
                      ...
                      className="w-full pl-9 pr-3 py-2 bg-white border border-slate-300/[0.08] rounded-xl text-xs text-gray-900 placeholder-slate-500 focus:outline-none focus:border-cyan-500"
                    />
                  </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {proveedoresList.map((prov: any) => (
                  <div key={prov.id} className="rounded-2xl bg-white border border-slate-300/[0.06] p-5 shadow-sm flex flex-col justify-between space-y-3 hover:border-slate-300 transition duration-300 group">
                    <div className="space-y-2">
                      <div className="flex items-start justify-between gap-2">
                        <span className="text-[10px] font-mono font-bold text-cyan-700 bg-cyan-500/10 px-2 py-0.5 rounded-md border border-slate-300">
                          {prov.id}
                        </span>
                    ...
                    <div className="pt-3 border-t border-slate-300/[0.04] flex items-center justify-between text-[11px]">
        ...
        {activeTab === 'facturacion' && (
          <div className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 p-3 rounded-2xl bg-white border border-slate-300/[0.06] backdrop-blur-xl">
              <div className="flex items-center gap-2">
                <span className="p-1.5 rounded-lg bg-purple-500/10 text-purple-700 border border-slate-300">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
              ...
              {chartModeFacturacion === 'bars' && (
                <div className="lg:col-span-5 rounded-3xl bg-white border border-slate-300/[0.08] p-6 shadow-sm space-y-5 backdrop-blur-xl">
                  <div className="border-b border-slate-300/[0.06] pb-4">
                    <h3 className="text-base font-bold text-gray-900 flex items-center gap-2">
                  ...
                  <div className="space-y-3">
                    {Object.entries(facturacionData.distribucion_zonas || {}).map(([zona, count]: any) => {
                      ...
                      return (
                        <div key={zona} className="space-y-1 p-2 rounded-2xl bg-white border border-slate-300/[0.04]">
                          <div className="flex items-center justify-between text-xs">
                          ...
                          <div className="w-full h-2 bg-white rounded-full overflow-hidden border border-slate-300/[0.06] flex">
                            <div className="bg-white border border-slate-300 h-full rounded-full" style={{ width: `${Math.max(percent, 4)}%` }} />
                          </div>
                        </div>
                      )
                    })}
              ...
              <div className={`${chartModeFacturacion === 'pie' ? 'lg:col-span-12' : 'lg:col-span-7'} rounded-3xl bg-white border border-slate-300/[0.08] p-6 shadow-sm space-y-5 backdrop-blur-xl`}>
                <div className="border-b border-slate-300/[0.06] pb-4 flex items-center justify-between">
                  <div>
                    <h3 className="text-base font-bold text-gray-900 flex items-center gap-2">
                  ...
                  <span className="text-xs font-mono font-bold px-3 py-1 rounded-xl bg-emerald-500/10 text-emerald-700 border border-slate-300">
                      ...
                      {(facturacionData.ultimas_facturas || []).map((f: any) => (
                        <tr key={f.factura_id} className="hover:bg-white/[0.04]">
                          ...
                          <td className="px-3 py-2.5">
                            <span className="px-2 py-0.5 rounded bg-white text-slate-700 border border-slate-300/[0.06] font-semibold text-[11px]">
                              {f.zona}
                            </span>
                          </td>
                          <td className="px-3 py-2.5 font-mono text-slate-700">{f.fecha}</td>
                          <td className="px-3 py-2.5 text-right">
                            <span className="inline-flex items-center gap-1 text-[11px] font-bold text-cyan-700 bg-cyan-500/10 px-2 py-0.5 rounded border border-slate-300">
      ...
      {showModal && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-50 backdrop-blur-xl animate-fade-in">
          <div className="bg-white border border-slate-300/[0.1] rounded-3xl w-full max-w-lg shadow-sm overflow-hidden flex flex-col">
            <div className="p-5 border-b border-slate-300/[0.06] flex items-center justify-between bg-white">
              <div className="flex items-center gap-2">
            ...
            <form onSubmit={handleSave} className="p-6 space-y-4">
              <div className="grid grid-cols-2 gap-3.5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-white border border-slate-300/[0.08] rounded-xl text-xs text-gray-900 focus:border-cyan-500"
                  />
                </div>
                <div>
              ...
              <div className="grid grid-cols-2 gap-3.5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 bg-white border border-slate-300/[0.08] rounded-xl text-xs text-gray-900"
                  />
                </div>
                <div className="flex items-center pt-5">
                  <label className="flex items-center gap-2 cursor-pointer">
                    <input
                      ...
                      className="w-4 h-4 rounded text-cyan-500 bg-white border-slate-300/[0.1]"
                    />
              ...
              <div className="pt-3 border-t border-slate-300/[0.06] flex items-center justify-end gap-2">
                <button
                  type="button"
                ...
                <button
                  type="submit"
                  className="px-5 py-2 rounded-xl bg-white border border-slate-300 hover:bg-gray-100 text-gray-900 text-xs font-bold shadow-sm transition"
                >
                  Guardar en Catálogo
                </button>
              </div>
