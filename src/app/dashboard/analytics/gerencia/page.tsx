...
export default function DashboardObligacionesPage() {
  ...
  return (
    <div className="space-y-6 pb-12">
      {/* Toast Notification */}
      {successToast && (
        <div className="fixed top-5 right-5 z-50 animate-bounce bg-emerald-600 text-white font-bold text-xs px-4 py-3 rounded-2xl shadow-md flex items-center gap-2 border border-[#333]">
      ...
      <div className="glass-card p-6 rounded-3xl border border-white/10 shadow-md bg-[#111] border border-[#333] relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
          <div>
            <div className="flex flex-wrap items-center justify-between gap-3 mb-2">
              <span className="badge bg-indigo-500/20 text-indigo-300 font-mono font-bold text-xs flex items-center gap-1 border border-[#333]">
              ...
              {((currentUserEmail || '').toLowerCase().includes('orellana') || (currentUserEmail || '').toLowerCase().includes('jose.gomez') || (currentUserEmail || '').toLowerCase().includes('lenny')) && (
                <button
                  ...
                  className="px-4 py-2 rounded-2xl bg-[#111] border border-[#333] hover:bg-[#222] text-slate-950 text-xs font-black flex items-center gap-2 transition-all transform hover:scale-105 cursor-pointer shadow-sm border border-teal-300"
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 bg-slate-950/80 p-3 rounded-2xl border border-[#333] shrink-0 shadow-xl">
            <div className="flex items-center gap-2.5 pr-2">
              <div className="w-9 h-9 rounded-xl bg-[#111] border border-[#333] flex items-center justify-center text-white shadow">
        ...
        {isConfiguringUser && (
          <div className="mt-4 pt-4 border-t border-white/10 animate-fade-in">
            <div className="bg-slate-950/80 p-4 rounded-2xl border border-[#333] flex flex-col md:flex-row items-stretch md:items-center gap-3">
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mt-6 pt-5 border-t border-white/10">
            ...
            <div className="flex rounded-xl bg-white/5 p-1 border border-white/10 text-xs font-bold">
              <button
                ...
                className={`px-3 py-1 rounded-lg transition-all text-xs cursor-pointer flex items-center gap-1.5 ${
                  chartType === 'pie'
                    ? 'bg-[#111] border border-[#333] text-white shadow'
          ...
          <div className="flex flex-wrap items-center gap-2">
            <button
              ...
              className="px-4 py-2 rounded-xl bg-[#111] border border-[#333] hover:bg-[#222] text-slate-950 text-xs font-black flex items-center gap-1.5 transition cursor-pointer shadow-sm"
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-[#111] border border-[#333] hover:from-amber-500/30 hover:to-orange-500/30 border border-[#333] text-xs font-bold text-amber-300 flex items-center gap-1.5 transition cursor-pointer shadow-sm"
      ...
      {!hasAccess ? (
        <div className="glass-card p-8 rounded-3xl border border-[#333] bg-[#111] border border-[#333] text-center space-y-4 shadow-md">
          <div className="w-16 h-16 rounded-3xl bg-amber-500/20 border border-[#333] mx-auto flex items-center justify-center text-amber-400 shadow-xl">
          ...
          <div className="pt-2">
            <button
              ...
              className="px-4 py-2 rounded-xl bg-amber-500/20 hover:bg-[#222] text-amber-300 text-xs font-bold border border-[#333] transition cursor-pointer"
            >
        ...
        <>
          ...
          <div className="glass-card rounded-3xl border border-white/10 shadow-md overflow-hidden bg-slate-900/90">
            <div className="p-4 border-b border-white/10 bg-slate-950/40 flex items-center justify-between">
              ...
              <span className="text-xs font-mono font-bold text-indigo-300 bg-indigo-500/10 px-2.5 py-1 rounded-xl border border-[#333]">
                100% Sincronizado
              </span>
            </div>
                        ...
                        >
                          ...
                          <td className="py-3 px-3">
                            <div className="flex items-center gap-1.5">
                              <div className="w-5 h-5 rounded-full bg-indigo-500/20 border border-[#333] flex items-center justify-center text-[9px] font-bold text-indigo-300 shrink-0">
                          ...
                          <td className="py-3 px-3 text-center">
                            <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold inline-flex items-center gap-1 ${
                              isRojo
                                ? 'bg-red-500/25 text-red-300 border border-[#333]'
                                : isNaranja
                                ? 'bg-amber-500/25 text-amber-300 border border-[#333]'
                                : 'bg-emerald-500/25 text-emerald-300 border border-[#333]'
                            }`}>
                          ...
                          <td className="py-3 px-3 text-right">
                            <button
                              ...
                              className="px-2.5 py-1 rounded-xl bg-indigo-500/20 hover:bg-[#222] text-indigo-300 border border-[#333] text-[11px] font-bold transition cursor-pointer"
          ...
          <div className="space-y-5 mt-2">
            ...
            <div className="glass-card p-5 rounded-3xl border border-[#333] bg-[#111] border border-[#333] relative overflow-hidden shadow-md">
              ...
              <div className="relative z-10 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
                <div className="flex items-start gap-3">
                  <div className="w-10 h-10 rounded-2xl bg-[#111] border border-[#333] flex items-center justify-center text-white shadow-sm shrink-0">
                    <ClipboardList className="w-5 h-5" />
                  </div>
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <span className="badge bg-amber-500/20 text-amber-300 font-mono font-bold text-[10px] border border-[#333] flex items-center gap-1">
                ...
                <div className="flex items-center gap-3 shrink-0">
                  ...
                  <div className="w-12 h-12 rounded-2xl bg-[#111] border border-[#333] border border-[#333] flex items-center justify-center">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-5 pt-5 border-t border-white/10 relative z-10">
                <div className="bg-slate-950/60 rounded-2xl p-3 border border-[#333]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
              {reporteCumplimiento.map((resp, idx) => {
                ...
                const cardBorder = esCritico
                  ? 'border-[#333] bg-red-950/10'
                  : esTop
                  ? 'border-[#333] bg-emerald-950/10'
                  : pct >= 70
                  ? 'border-[#333]'
                  : 'border-[#333] bg-amber-950/10'
                ...
                const badgeStyle = esTop
                  ...
                  : esCritico
                  ? 'bg-red-500/20 text-red-300 border-[#333]'
                  : pct >= 70
                ...
                return (
                  ...
                  >
                    ...
                    <div className="grid grid-cols-4 gap-1.5 mb-3">
                      ...
                      <div className="bg-slate-950/60 rounded-xl p-2 text-center border border-[#333]">
            ...
            <div className="glass-card rounded-3xl border border-white/10 shadow-md overflow-hidden bg-slate-900/90">
              <div className="p-4 border-b border-white/10 bg-slate-950/40 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  <div className="w-7 h-7 rounded-xl bg-[#111] border border-[#333] flex items-center justify-center text-white shadow">
                ...
                <span className="text-xs font-mono font-bold text-amber-300 bg-amber-500/10 px-2.5 py-1 rounded-xl border border-[#333] shrink-0">
                    ...
                    {reporteCumplimiento.map((resp, idx) => {
                      ...
                      return (
                        <tr key={resp.nombre} className={`hover:bg-white/[0.04] transition-colors ${
                          ...
                          <td className="py-3 px-3 text-center">
                            {resp.criticos > 0 ? (
                              <span className="px-2 py-0.5 rounded-full bg-red-500/25 text-red-300 border border-[#333] font-bold font-mono">
                                {resp.criticos}
                              </span>
                            ) : (
                          ...
                          <td className="py-3 px-3 text-center">
                            {resp.advertencia > 0 ? (
                              <span className="px-2 py-0.5 rounded-full bg-amber-500/25 text-amber-300 border border-[#333] font-bold font-mono">
                                {resp.advertencia}
                              </span>
                            ) : (
                              <span className="text-gray-500 font-mono">—</span>
                          ...
                          <td className="py-3 px-3 text-center">
                            {resp.criticos === 0 && pct >= 80 ? (
                              <span className="px-2.5 py-1 rounded-full bg-emerald-500/20 text-emerald-300 border border-[#333] text-[10px] font-bold">✅ Óptimo</span>
                            ) : resp.criticos > 1 ? (
                              <span className="px-2.5 py-1 rounded-full bg-red-500/20 text-red-300 border border-[#333] text-[10px] font-bold">🚨 Atención</span>
                            ) : (
                              <span className="px-2.5 py-1 rounded-full bg-amber-500/20 text-amber-300 border border-[#333] text-[10px] font-bold">⚠️ Monitorear</span>
                            )}
                          </td>
                        </tr>
                      )
              ...
              <div className="p-4 border-t border-white/5 bg-slate-950/40">
                <div className="flex flex-wrap items-center gap-4">
                  ...
                  <span className="ml-auto text-[10px] font-mono text-indigo-300 bg-indigo-500/10 px-2.5 py-1 rounded-xl border border-[#333] shrink-0">
          ...
          {((currentUserEmail || '').toLowerCase().includes('orellana') || (currentUserEmail || '').toLowerCase().includes('jose.gomez') || (currentUserEmail || '').toLowerCase().includes('lenny')) && (
            <div id="reporte-actividades-realizadas" className="glass-card p-6 md:p-8 rounded-3xl border border-[#333] bg-[#111] border border-[#333] shadow-md space-y-4 mt-8">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="badge bg-amber-500/20 text-amber-300 font-mono text-xs border border-[#333] px-3 py-1">
                ...
                <a
                  ...
                  className="px-5 py-3 rounded-2xl bg-[#111] border border-[#333] text-slate-950 font-black text-xs flex items-center gap-2 transition hover:opacity-90 shadow-sm shrink-0 self-start md:self-auto cursor-pointer"
                >
