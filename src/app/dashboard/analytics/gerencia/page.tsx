...
export default function DashboardObligacionesPage() {
  ...
  return (
    <div className="space-y-6 pb-12">
      {/* Toast Notification */}
      {successToast && (
        <div className="fixed top-5 right-5 z-50 animate-bounce bg-emerald-600 text-gray-900 font-bold text-xs px-4 py-3 rounded-2xl shadow-md flex items-center gap-2 border border-gray-200">
      ...
      <div className="glass-card p-6 rounded-3xl border border-white/10 shadow-md bg-white border border-gray-200 relative overflow-hidden">
        ...
        <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 relative z-10">
          <div>
            <div className="flex flex-wrap items-center justify-between gap-3 mb-2">
              <span className="badge bg-indigo-500/20 text-indigo-300 font-mono font-bold text-xs flex items-center gap-1 border border-gray-200">
          ...
          <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2.5 bg-slate-950/80 p-3 rounded-2xl border border-gray-200 shrink-0 shadow-xl">
            ...
            <button
              ...
              className="px-3 py-1.5 rounded-xl bg-white/5 hover:bg-white/10 text-gray-700 border border-white/10 text-xs font-bold flex items-center justify-center gap-1.5 transition cursor-pointer"
        ...
        {isConfiguringUser && (
          <div className="mt-4 pt-4 border-t border-white/10 animate-fade-in">
            <div className="bg-slate-950/80 p-4 rounded-2xl border border-gray-200 flex flex-col md:flex-row items-stretch md:items-center gap-3">
              <div className="flex-1">
                ...
                <input
                  ...
                  className="w-full bg-slate-900 border border-white/15 rounded-xl px-3.5 py-2 text-xs text-gray-900 font-mono outline-none focus:border-indigo-500"
                />
              </div>
              <div className="flex items-center gap-2 pt-2 md:pt-4">
                ...
                <button
                  ...
                  className="px-3 py-2 rounded-xl bg-white/5 hover:bg-white/10 text-gray-500 hover:text-gray-900 text-xs font-bold cursor-pointer"
                >
                  Cancelar
                </button>
              </div>
        ...
        <div className="flex flex-wrap items-center justify-between gap-3 mt-6 pt-5 border-t border-white/10">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="px-3.5 py-2 rounded-xl bg-white border border-gray-200 hover:from-amber-500/30 hover:to-orange-500/30 border border-gray-200 text-xs font-bold text-amber-300 flex items-center gap-1.5 transition cursor-pointer shadow-sm"
      ...
      {!hasAccess ? (
        <div className="glass-card p-8 rounded-3xl border border-gray-200 bg-white border border-gray-200 text-center space-y-4 shadow-md">
          <div className="w-16 h-16 rounded-3xl bg-amber-500/20 border border-gray-200 mx-auto flex items-center justify-center text-amber-400 shadow-xl">
          ...
          <div className="pt-2">
            <button
              ...
              className="px-4 py-2 rounded-xl bg-amber-500/20 hover:bg-gray-100 text-amber-300 text-xs font-bold border border-gray-200 transition cursor-pointer"
            >
        ...
        <>
          ...
          <div className="glass-card p-4 rounded-2xl border border-white/10 shadow-xl flex flex-wrap items-center justify-between gap-3 text-xs bg-slate-900/80">
            ...
            <div className="relative min-w-[240px]">
              ...
              <input
                ...
                className="w-full bg-slate-950 text-gray-900 pl-8 pr-3 py-1.5 rounded-xl border border-white/10 outline-none text-xs focus:border-indigo-500"
              />
            </div>
          </div>

          {/* 5. Tabla Matriz Completa de Obligaciones */}
          <div className="glass-card rounded-3xl border border-white/10 shadow-md overflow-hidden bg-slate-900/90">
            <div className="p-4 border-b border-white/10 bg-slate-950/40 flex items-center justify-between">
              ...
              <span className="text-xs font-mono font-bold text-indigo-300 bg-indigo-500/10 px-2.5 py-1 rounded-xl border border-gray-200">
                100% Sincronizado
              </span>
            </div>
            ...
            <div className="overflow-x-auto">
              <table className="w-full text-left text-xs border-collapse">
                <thead>
                  <tr className="bg-slate-950/80 text-gray-500 uppercase text-[10px] font-mono border-b border-white/10">
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="py-3 px-3">
                            <span className="font-bold text-gray-900 block truncate max-w-[170px]" title={item.cliente}>
                              {item.cliente}
                            </span>
                          </td>
                          ...
                          <td className="py-3 px-4 max-w-sm">
                            ...
                            {item.comentario && (
                              <p className="text-[11px] text-gray-500 italic mt-1 bg-slate-950/40 p-1.5 rounded-lg border border-white/5">
                                💬 {item.comentario}
                              </p>
                            )}
                          </td>
                          ...
                          <td className="py-3 px-3">
                            <div className="flex items-center gap-1.5">
                              <div className="w-5 h-5 rounded-full bg-indigo-500/20 border border-gray-200 flex items-center justify-center text-[9px] font-bold text-indigo-300 shrink-0">
                                {item.responsable.charAt(0)}
                              </div>
                              <div className="truncate max-w-[130px]">
                                <span className="font-bold text-gray-900 text-xs block truncate" title={item.responsable}>
                                  {item.responsable}
                                </span>
                                <span className="text-[9px] text-gray-500 block truncate" title={item.responsableEmail}>
                          ...
                          <td className="py-3 px-3 text-center font-mono font-bold text-xs">
                            <span className={item.fecha_cumplimiento.startsWith('2029') ? 'text-cyan-300' : 'text-gray-700'}>
                              {item.fecha_cumplimiento}
                            </span>
                          </td>
                          ...
                          <td className="py-3 px-3 text-center">
                            <span className={`px-2.5 py-1 rounded-full text-[10px] font-bold inline-flex items-center gap-1 ${
                              isRojo
                                ? 'bg-red-500/25 text-red-300 border border-gray-200'
                                : isNaranja
                                ? 'bg-amber-500/25 text-amber-300 border border-gray-200'
                                : 'bg-emerald-500/25 text-emerald-300 border border-gray-200'
                            }`}>
                          ...
                          <td className="py-3 px-3 text-right">
                            <button
                              ...
                              className="px-2.5 py-1 rounded-xl bg-indigo-500/20 hover:bg-gray-100 text-indigo-300 border border-gray-200 text-[11px] font-bold transition cursor-pointer"
          ...
          <div className="space-y-5 mt-2">
            ...
            <div className="glass-card p-5 rounded-3xl border border-gray-200 bg-white border border-gray-200 relative overflow-hidden shadow-md">
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <span className="badge bg-amber-500/20 text-amber-300 font-mono font-bold text-[10px] border border-gray-200 flex items-center gap-1">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-5 pt-5 border-t border-white/10 relative z-10">
                <div className="bg-slate-950/60 rounded-2xl p-3 border border-gray-200">
                ...
                <div className="bg-slate-950/60 rounded-2xl p-3 border border-gray-200">
                  ...
                  <span className="text-[10px] text-gray-500">Responsables con tareas en rojo</span>
                </div>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-4">
              {reporteCumplimiento.map((resp, idx) => {
                ...
                const cardBorder = esCritico
                  ? 'border-gray-200 bg-red-950/10'
                  : esTop
                  ? 'border-gray-200 bg-emerald-950/10'
                  : pct >= 70
                  ? 'border-gray-200'
                  : 'border-gray-200 bg-amber-950/10'
                ...
                const badgeStyle = esTop
                  ...
                  : esCritico
                  ? 'bg-red-500/20 text-red-300 border-gray-200'
                  : pct >= 70
                  ? 'bg-indigo-500/20 text-indigo-300 border-gray-200'
                ...
                return (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-3 mb-4">
                      <div
                        className="w-10 h-10 rounded-2xl flex items-center justify-center text-sm font-black text-gray-900 shadow-lg shrink-0"
                        style={{ background: `linear-gradient(135deg, ${AREA_COL[resp.area] || '#6366F1'}99, ${AREA_COL[resp.area] || '#8B5CF6'})` }}
                      >
                        #{idx + 1}
                      </div>
                      <div className="flex-1 min-w-0">
                        <p className="font-black text-gray-900 text-sm truncate">{resp.nombre}</p>
                    ...
                    <div className="mb-4">
                      <div className="flex items-center justify-between mb-1.5">
                        <span className="text-[10px] text-gray-500 font-bold uppercase">Tasa de Cumplimiento</span>
                    ...
                    <div className="grid grid-cols-4 gap-1.5 mb-3">
                      ...
                      <div className="bg-slate-950/60 rounded-xl p-2 text-center border border-gray-200">
            ...
            <div className="glass-card rounded-3xl border border-white/10 shadow-md overflow-hidden bg-slate-900/90">
              <div className="p-4 border-b border-white/10 bg-slate-950/40 flex items-center justify-between">
                <div className="flex items-center gap-2.5">
                  ...
                  <div>
                    <h3 className="text-sm font-black text-gray-900">Ranking de Cumplimiento por Responsable</h3>
                ...
                <span className="text-xs font-mono font-bold text-amber-300 bg-amber-500/10 px-2.5 py-1 rounded-xl border border-gray-200 shrink-0">
                      ...
                      return (
                        <tr key={resp.nombre} className={`hover:bg-white/[0.04] transition-colors ${
                          ...
                          <td className="py-3 px-3">
                            <div className="flex items-center gap-2">
                              <div
                                className="w-6 h-6 rounded-lg flex items-center justify-center text-[10px] font-black text-gray-900 shrink-0"
                                style={{ background: `${AREA_COL[resp.area] || '#6366F1'}40`, border: `1px solid ${AREA_COL[resp.area] || '#6366F1'}50` }}
                              >
                                {resp.nombre.charAt(0)}
                              </div>
                              <div>
                                <span className="font-black text-gray-900 text-xs block">{resp.nombre}</span>
                                <span className="text-[10px] text-gray-500">{resp.email || 'Sin email'}</span>
                              </div>
                            </div>
                          </td>
                          ...
                          <td className="py-3 px-3 text-center font-mono font-black text-gray-900">{resp.total}</td>
                          ...
                          <td className="py-3 px-3 text-center">
                            {resp.criticos > 0 ? (
                              <span className="px-2 py-0.5 rounded-full bg-red-500/25 text-red-300 border border-gray-200 font-bold font-mono">
                                {resp.criticos}
                              </span>
                            ) : (
                          ...
                          <td className="py-3 px-3 text-center">
                            {resp.advertencia > 0 ? (
                              <span className="px-2 py-0.5 rounded-full bg-amber-500/25 text-amber-300 border border-gray-200 font-bold font-mono">
                                {resp.advertencia}
                              </span>
                            ) : (
                              <span className="text-gray-500 font-mono">—</span>
                          ...
                          <td className="py-3 px-3 text-center">
                            {resp.criticos === 0 && pct >= 80 ? (
                              <span className="px-2.5 py-1 rounded-full bg-emerald-500/20 text-emerald-300 border border-gray-200 text-[10px] font-bold">✅ Óptimo</span>
                            ) : resp.criticos > 1 ? (
                              <span className="px-2.5 py-1 rounded-full bg-red-500/20 text-red-300 border border-gray-200 text-[10px] font-bold">🚨 Atención</span>
                            ) : (
                              <span className="px-2.5 py-1 rounded-full bg-amber-500/20 text-amber-300 border border-gray-200 text-[10px] font-bold">⚠️ Monitorear</span>
                            )}
                          </td>
                        </tr>
                      )
              ...
              <div className="p-4 border-t border-white/5 bg-slate-950/40">
                <div className="flex flex-wrap items-center gap-4">
                  <div className="flex items-center gap-1.5">
                    ...
                    <span className="text-[10px] text-gray-500 font-bold">NOTA EJECUTIVA: </span>
                  ...
                  <span className="ml-auto text-[10px] font-mono text-indigo-300 bg-indigo-500/10 px-2.5 py-1 rounded-xl border border-gray-200 shrink-0">
          ...
          {((currentUserEmail || '').toLowerCase().includes('orellana') || (currentUserEmail || '').toLowerCase().includes('jose.gomez') || (currentUserEmail || '').toLowerCase().includes('lenny')) && (
            <div id="reporte-actividades-realizadas" className="glass-card p-6 md:p-8 rounded-3xl border border-gray-200 bg-white border border-gray-200 shadow-md space-y-4 mt-8">
              <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div className="space-y-1">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="badge bg-amber-500/20 text-amber-300 font-mono text-xs border border-gray-200 px-3 py-1">
