    ...
    <div className="p-6 max-w-7xl mx-auto space-y-6">
      ...
      <div className="bg-white border border-slate-300 rounded-2xl p-4 flex flex-col md:flex-row items-center justify-between gap-4">
        <div className="relative w-full md:w-80">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-white border border-slate-300 rounded-xl text-xs text-gray-900 placeholder-slate-500 focus:outline-none focus:border-emerald-500 transition"
          />
        </div>
        ...
        <select
          ...
          className="px-3 py-2 bg-white border border-slate-300 rounded-xl text-xs text-slate-700 focus:outline-none focus:border-emerald-500"
        >
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        {loading ? (
          ...
          filteredContratos.map(c => (
            <div
              key={c.contrato_id}
              className="bg-white border border-slate-300 rounded-2xl p-5 shadow-sm space-y-4 flex flex-col justify-between"
            >
              <div className="space-y-3">
                <div className="flex items-start justify-between gap-2">
                  ...
                  {c.monto_total && (
                    <span className="text-xs font-mono font-bold text-emerald-700 bg-emerald-500/10 px-2.5 py-1 rounded-lg border border-slate-300">
              ...
              <div className="pt-3 border-t border-slate-300 flex items-center justify-end">
                <button
                  onClick={() => handleOpenEdit(c)}
                  className="flex items-center gap-1.5 px-3 py-1.5 rounded-xl bg-slate-100 hover:bg-gray-100 text-slate-700 hover:text-emerald-700 border border-slate-700 hover:border-slate-300 text-xs font-bold transition"
                >
      ...
      {editingContrato && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-white backdrop-blur-sm animate-fade-in">
          <div className="bg-white border border-slate-300 rounded-2xl w-full max-w-md shadow-sm overflow-hidden flex flex-col">
                ...
                <div className="grid grid-cols-2 gap-2">
                  <div>
                    ...
                    <select
                      ...
                      className="w-full px-2.5 py-1.5 bg-white border border-slate-300 rounded-lg text-xs text-gray-900"
                    >
