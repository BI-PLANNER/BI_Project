...
export default function NotificacionesObligacionesModal({ isOpen, onClose }: NotificacionesModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-50 backdrop-blur-md p-4 overflow-y-auto">
      <div className="glass-card w-full max-w-4xl p-6 md:p-8 animate-scale-in border border-slate-200 shadow-sm rounded-3xl bg-white max-h-[90vh] flex flex-col">
        {/* Header */}
        <div className="flex items-center justify-between pb-4 border-b border-slate-200">
          <div className="flex items-center gap-3">
            <div className="p-3 rounded-2xl bg-white border border-gray-200 text-amber-700 border border-gray-200">
            ...
            <div>
              <div className="flex items-center gap-2">
                ...
                <span className="badge bg-indigo-500/20 text-indigo-700 font-mono text-[10px] border border-gray-200">
                  COMPRASAL / VERCEL
                </span>
              </div>
        ...
        {/* Success Toast */}
        {sentSuccess && (
          <div className="mt-4 p-4 rounded-2xl bg-emerald-500/20 border border-gray-200 text-emerald-700 flex items-center gap-3 animate-fade-in text-xs font-semibold">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-3 my-4">
          <div className="p-3.5 rounded-2xl bg-white/[0.03] border border-slate-200 flex items-center gap-3">
        ...
        <div className="flex-1 overflow-y-auto space-y-2.5 pr-1">
          {loading && !data ? (
            ...
            data?.resultados?.map((persona: any, idx: number) => (
              <div
                key={idx}
                className="p-3.5 rounded-2xl bg-white/[0.02] border border-slate-200 hover:border-gray-200 transition flex flex-col sm:flex-row sm:items-center justify-between gap-3"
              >
                <div className="flex items-center gap-3">
                  <div className="w-9 h-9 rounded-xl bg-white border border-gray-200 text-indigo-700 font-bold text-xs flex items-center justify-center border border-gray-200">
                  ...
                  <div>
                    ...
                    <div className="flex items-center gap-2 mt-0.5">
                      ...
                      {persona.criticas > 0 && (
                        <span className="badge bg-rose-500/20 text-rose-700 border border-gray-200 text-[9px] px-1.5 font-mono font-bold">
                ...
                <div className="flex items-center gap-2 self-end sm:self-auto">
                  ...
                  <button
                    ...
                    className="px-2.5 py-1.5 rounded-xl bg-emerald-500/10 hover:bg-gray-100 text-emerald-700 text-[11px] font-medium flex items-center gap-1.5 border border-gray-200 transition"
        ...
        {/* Footer Actions */}
        <div className="pt-4 mt-4 border-t border-slate-200 flex flex-col sm:flex-row sm:items-center justify-between gap-3">
      ...
      {previewOpen && selectedPersona && (
        <div className="fixed inset-0 z-60 flex items-center justify-center bg-slate-50 p-4">
          <div className="glass-card w-full max-w-3xl p-6 rounded-3xl border border-slate-200 shadow-sm bg-white flex flex-col max-h-[85vh]">
            ...
            <div className="flex-1 overflow-y-auto my-4 p-4 rounded-2xl bg-white border border-slate-200">
              <div
