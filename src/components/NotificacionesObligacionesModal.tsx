...
export default function NotificacionesObligacionesModal({ isOpen, onClose }: NotificacionesModalProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/80 backdrop-blur-md p-4 overflow-y-auto">
      <div className="glass-card w-full max-w-4xl p-6 md:p-8 animate-scale-in border border-white/10 shadow-md rounded-3xl bg-slate-950/95 max-h-[90vh] flex flex-col">
        {/* Header */}
