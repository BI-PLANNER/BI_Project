  ...
  return (
    <div className={`relative ${isSidebar ? 'w-full' : 'inline-block'} ${className}`}>
      ...
      {collapsed ? (
        ...
        >
          ...
          <div className="flex flex-col text-left leading-none pr-1">
            <span className="text-[10px] font-bold text-slate-700">Alertas</span>
            <span className="text-xs font-black font-mono text-gray-900 flex items-center gap-1 mt-0.5">
              {criticalCount > 0 ? (
                <span className="text-rose-700">{criticalCount} Críticas</span>
              ) : (
                <span className="text-emerald-700">0 Quiebres</span>
              )}
            </span>
          </div>
        </button>
      ...
      {isOpen && mounted && createPortal(
        <div 
          className="fixed inset-0 z-[99999] flex items-center justify-center p-3 sm:p-6 md:p-8 bg-slate-50 backdrop-blur-xl animate-in fade-in duration-200"
          onClick={(e) => {
        ...
        >
          ...
          >
              ...
              <div className="flex items-center gap-3.5">
                ...
                <div>
                  ...
                  <p className="text-xs text-slate-700 mt-0.5 flex items-center gap-1.5">
                    ...
                    <span className="font-mono text-cyan-700">{lastSyncTime}</span>
                  </p>
                </div>
              </div>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 p-4 sm:p-5 bg-slate-500 border-b border-slate-200 flex-shrink-0">
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="text-[11px] font-bold text-rose-700">Peligro Quiebre</span>
                ...
                <div className="text-[10px] text-slate-700 mt-0.5">Stock &le; SS (&lt; 15 días)</div>
              </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="text-[11px] font-bold text-amber-700">Punto Reorden</span>
                  <AlertTriangle className="w-4 h-4 text-amber-700" />
                </div>
                <div className="text-2xl font-black text-amber-700 font-mono mt-1">
                  {resumen.reorden_sugerido}
                </div>
                <div className="text-[10px] text-slate-700 mt-0.5">Stock + Tránsito &le; ROP</div>
              </div>
              ...
              >
                <div className="flex items-center justify-between">
                  <span className="text-[11px] font-bold text-indigo-700">Riesgo FEFO</span>
              ...
              <div className="p-3.5 rounded-2xl bg-emerald-50 border border-gray-200">
                ...
                <div className="text-[10px] text-slate-700 mt-0.5">Reposición óptima sugerida</div>
              </div>
            </div>
            ...
            <div className="p-4 sm:p-5 border-b border-slate-200 flex flex-col md:flex-row items-stretch md:items-center justify-between gap-3 bg-white flex-shrink-0">
              ...
              <div className="flex items-center gap-1.5 p-1 bg-white rounded-2xl border border-slate-200 overflow-x-auto">
                ...
                <button
                  ...
                  className={`px-3 py-1.5 rounded-xl text-xs font-bold transition whitespace-nowrap cursor-pointer ${
                    activeFilter === 'CRITICO'
                      ? 'bg-rose-600 text-gray-900 shadow-sm'
                      : 'text-rose-700 hover:bg-gray-100'
                  }`}
                >
            ...
            <div className="flex-1 overflow-y-auto p-4 sm:p-6 space-y-3 min-h-0 bg-slate-500">
              {filteredAlertas.length === 0 ? (
                <div className="text-center py-16 text-slate-500">
                  <CheckCircle2 className="w-12 h-12 text-emerald-700/40 mx-auto mb-3" />
                  <p className="text-sm font-semibold text-slate-700">No hay alertas en esta categoría</p>
                      ...
                      >
                        ...
                        <div className="space-y-2 min-w-[320px] flex-1">
                          ...
                          <p className="text-xs text-slate-700 flex items-center gap-1.5">
                            ...
                            <span className={isCritico ? 'text-rose-700 font-semibold' : 'text-slate-700'}>
                        ...
                        <div className="grid grid-cols-3 sm:grid-cols-4 gap-3 text-center border-t lg:border-t-0 lg:border-l border-slate-200 pt-3 lg:pt-0 lg:pl-4">
                          ...
                          <div className="p-2 rounded-xl bg-emerald-50 border border-gray-200 col-span-3 sm:col-span-1">
                            ...
                            <div className="text-[9.5px] font-mono text-emerald-700/80">
